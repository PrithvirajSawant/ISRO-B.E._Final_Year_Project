...
INSERT INTO `addagroproducts` (`username`, `email`, `pid`, `productname`, `productdesc`) VALUES
('test', 'test@gmail.com', 1, 'REMOTE SENSING', ' Tips for Growing Cauliflower. Well drained medium loam and or sandy loam soils are suitable.'),
('test', 'test@gmail.com', 2, 'ML Forecasting', 'Cotton is a soft, fluffy staple fiber that grows in a boll,around the seeds of the cotton '),
('arkpro', 'arkpro@gmail.com', 3, 'Image Processing', 'silk is best business developed from coocon for saries preparation and so on');

ALTER TABLE addagroproducts DROP COLUMN PRICE;
-- --------------------------------------------------------
